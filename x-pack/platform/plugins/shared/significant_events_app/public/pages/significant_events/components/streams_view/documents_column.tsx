...
import { getMeaningfulBucketMs } from '../../../../util/stream_histogram_esql';
...
export function DocumentsColumn({
  ...
  indexPattern: string;
  histogramQueryFetch: Promise<ESQLSearchResponse>;
  ...
  const cellAriaLabel = hasData
    ? i18n.translate('xpack.significantEventsApp.documentsColumn.cellDocCountLabel', {
        defaultMessage: '{docCount} documents in {indexPattern}',
        values: { docCount, indexPattern },
      })
    : i18n.translate('xpack.significantEventsApp.documentsColumn.cellNoDataLabel', {
