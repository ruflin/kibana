...
export const insightStorageSettings = {
  ...
  schema: {
    properties: {
      ...
      [INSIGHT_RELATED_FEATURE_UUIDS]: types.keyword(),
      [INSIGHT_RELATED_QUERY_IDS]: types.keyword(),
      [INSIGHT_PARENT_INSIGHT_ID]: types.keyword(),
      [INSIGHT_RELATED_INSIGHT_IDS]: types.keyword(),
      [INSIGHT_FEEDBACK]: types.object({ enabled: false }),
