...
export const platformSignificantEventsTools = {
  ...
  sampleStreamDocuments: `${internalNamespaces.platformSignificantEvents}.ki_sample_documents`,
  persistFeatures: `${internalNamespaces.platformSignificantEvents}.ki_feature_persist`,
  validateKiQuery: `${internalNamespaces.platformSignificantEvents}.ki_query_validate`,
