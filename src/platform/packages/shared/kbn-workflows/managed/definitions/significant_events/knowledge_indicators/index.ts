...
import AI_INDEX_EXTRACTION_YAML from './ai_index_extraction.yaml';
...
export const SIGNIFICANT_EVENTS_AI_INDEX_EXTRACTION_WORKFLOW_ID =
...
export const SIGNIFICANT_EVENTS_AI_INDEX_EXTRACTION_WORKFLOW = {
  id: SIGNIFICANT_EVENTS_AI_INDEX_EXTRACTION_WORKFLOW_ID,
  pluginId: 'significantEvents',
  version: 1,
  billable: false,
  yaml: AI_INDEX_EXTRACTION_YAML,
  management: SIGNIFICANT_EVENTS_KI_WORKFLOW_MANAGEMENT,
} as const satisfies ManagedWorkflowDefinition;
