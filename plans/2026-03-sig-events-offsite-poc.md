...
- `x-pack/platform/plugins/shared/streams/server/routes/internal/streams/topology/route.ts` — `GET _topology` (read persisted) + `POST _topology` (generate via LLM and persist to saved object)
